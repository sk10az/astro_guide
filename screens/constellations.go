...
func loadConstellationsIcons() []constellationsIconInfo {
	...
	var андромеда = fyne.NewStaticResource("1.jpg", resources.Constellations1)
	большаяМедведица := fyne.NewStaticResource("2.jpg", resources.Constellations2)
	большойПёс := fyne.NewStaticResource("3.jpg", resources.Constellations3)
	близнецы := fyne.NewStaticResource("4.jpg", resources.Constellations4)
	чаша := fyne.NewStaticResource("5.jpg", resources.Constellations5)
	часы := fyne.NewStaticResource("6.jpg", resources.Constellations6)
	дельфин := fyne.NewStaticResource("7.jpg", resources.Constellations7)
	дева := fyne.NewStaticResource("8.jpg", resources.Constellations8)
	дракон := fyne.NewStaticResource("9.jpg", resources.Constellations9)
	единорог := fyne.NewStaticResource("10.jpg", resources.Constellations10)
	эридан := fyne.NewStaticResource("11.jpg", resources.Constellations11)
	геркулес := fyne.NewStaticResource("12.jpg", resources.Constellations12)
	жертвенник := fyne.NewStaticResource("13.jpg", resources.Constellations13)
	жираф := fyne.NewStaticResource("14.jpg", resources.Constellations14)
	живописец := fyne.NewStaticResource("15.jpg", resources.Constellations15)
	журавль := fyne.NewStaticResource("16.jpg", resources.Constellations16)
	гидра := fyne.NewStaticResource("17.jpg", resources.Constellations17)
	голубь := fyne.NewStaticResource("18.jpg", resources.Constellations18)
	гончиеПсы := fyne.NewStaticResource("19.jpg", resources.Constellations19)
	хамелеон := fyne.NewStaticResource("20.jpg", resources.Constellations20)
	индеец := fyne.NewStaticResource("21.jpg", resources.Constellations21)
	кассиопея := fyne.NewStaticResource("22.jpg", resources.Constellations22)
	киль := fyne.NewStaticResource("23.jpg", resources.Constellations23)
	кит := fyne.NewStaticResource("24.jpg", resources.Constellations24)
	компас := fyne.NewStaticResource("25.jpg", resources.Constellations25)
	корма := fyne.NewStaticResource("26.jpg", resources.Constellations26)
	козерог := fyne.NewStaticResource("27.jpg", resources.Constellations27)
	лебедь := fyne.NewStaticResource("28.jpg", resources.Constellations28)
	летучаяРыба := fyne.NewStaticResource("29.jpg", resources.Constellations29)
	лев := fyne.NewStaticResource("30.jpg", resources.Constellations30)
	лира := fyne.NewStaticResource("31.jpg", resources.Constellations31)
	лисичка := fyne.NewStaticResource("32.jpg", resources.Constellations32)
	малаяМедведица := fyne.NewStaticResource("33.jpg", resources.Constellations33)
	малыйКонь := fyne.NewStaticResource("34.jpg", resources.Constellations34)
	малыйЛев := fyne.NewStaticResource("35.jpg", resources.Constellations35)
	малыйПёс := fyne.NewStaticResource("36.jpg", resources.Constellations36)
	микроскоп := fyne.NewStaticResource("37.jpg", resources.Constellations37)
	муха := fyne.NewStaticResource("38.jpg", resources.Constellations38)
	насос := fyne.NewStaticResource("39.jpg", resources.Constellations39)
	наугольник := fyne.NewStaticResource("40.jpg", resources.Constellations40)
	октант := fyne.NewStaticResource("41.jpg", resources.Constellations41)
	орёл := fyne.NewStaticResource("42.jpg", resources.Constellations42)
	орион := fyne.NewStaticResource("43.jpg", resources.Constellations43)
	овен := fyne.NewStaticResource("44.jpg", resources.Constellations44)
	паруса := fyne.NewStaticResource("45.jpg", resources.Constellations45)
	павлин := fyne.NewStaticResource("46.jpg", resources.Constellations46)
	печь := fyne.NewStaticResource("47.jpg", resources.Constellations47)
	пегас := fyne.NewStaticResource("48.jpg", resources.Constellations48)
