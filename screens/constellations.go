...
func loadConstellationsIcons() []constellationsIconInfo {
	...
	icons = append(icons, constellationsIconInfo{name: "паруса", icon: fyne.NewStaticResource("44.jpg", resources.Constellations45), description: "Журавль - символ мудрости"})
	icons = append(icons, constellationsIconInfo{name: "павлин", icon: fyne.NewStaticResource("45.jpg", resources.Constellations46), description: "Журавль - символ мудрости"})
	icons = append(icons, constellationsIconInfo{name: "печь", icon: fyne.NewStaticResource("46.jpg", resources.Constellations47), description: "Журавль - символ мудрости"})
	icons = append(icons, constellationsIconInfo{name: "пегас", icon: fyne.NewStaticResource("47.jpg", resources.Constellations48), description: "Журавль - символ мудрости"})

	//персей := fyne.NewStaticResource("49.jpg", resources.Constellations49)
	//феникс := fyne.NewStaticResource("50.jpg", resources.Constellations50)
	//рак := fyne.NewStaticResource("51.jpg", resources.Constellations51)
	//райскаяПтица := fyne.NewStaticResource("52.jpg", resources.Constellations52)
	//резец := fyne.NewStaticResource("53.jpg", resources.Constellations53)
	//рыбы := fyne.NewStaticResource("54.jpg", resources.Constellations54)
	//рысь := fyne.NewStaticResource("55.jpg", resources.Constellations55)
	//секстант := fyne.NewStaticResource("56.jpg", resources.Constellations56)
	//сетка := fyne.NewStaticResource("57.jpg", resources.Constellations57)
	//севернаяКорона := fyne.NewStaticResource("58.jpg", resources.Constellations58)
	//щит := fyne.NewStaticResource("59.jpg", resources.Constellations59)
	//скорпион := fyne.NewStaticResource("60.jpg", resources.Constellations60)
	//скульптор := fyne.NewStaticResource("61.jpg", resources.Constellations61)
	//столоваяГора := fyne.NewStaticResource("62.jpg", resources.Constellations62)
	//стрела := fyne.NewStaticResource("63.jpg", resources.Constellations63)
	//стрелец := fyne.NewStaticResource("64.jpg", resources.Constellations64)
	//цефей := fyne.NewStaticResource("65.jpg", resources.Constellations65)
	//центавр := fyne.NewStaticResource("66.jpg", resources.Constellations66)
	//циркуль := fyne.NewStaticResource("67.jpg", resources.Constellations67)
	//телескоп := fyne.NewStaticResource("68.jpg", resources.Constellations68)
	//телец := fyne.NewStaticResource("69.jpg", resources.Constellations69)
	//треугольник := fyne.NewStaticResource("70.jpg", resources.Constellations70)
	//тукан := fyne.NewStaticResource("71.jpg", resources.Constellations71)
	//южнаяГидра := fyne.NewStaticResource("72.jpg", resources.Constellations72)
	//южнаяКорона := fyne.NewStaticResource("73.jpg", resources.Constellations73)
	//южнаяРыба := fyne.NewStaticResource("74.jpg", resources.Constellations74)
	//южныйТреугольник := fyne.NewStaticResource("75.jpg", resources.Constellations75)
	//южныйКрест := fyne.NewStaticResource("76.jpg", resources.Constellations76)
	//весы := fyne.NewStaticResource("77.jpg", resources.Constellations77)
	//водолей := fyne.NewStaticResource("78.jpg", resources.Constellations78)
	//волк := fyne.NewStaticResource("79.jpg", resources.Constellations79)
	//волопас := fyne.NewStaticResource("80.jpg", resources.Constellations80)
	//волосыВероники := fyne.NewStaticResource("81.jpg", resources.Constellations81)
	//ворон := fyne.NewStaticResource("82.jpg", resources.Constellations82)
	//возничий := fyne.NewStaticResource("83.jpg", resources.Constellations83)
	//ящерица := fyne.NewStaticResource("84.jpg", resources.Constellations84)
	//заяц := fyne.NewStaticResource("85.jpg", resources.Constellations85)
	//змееносец := fyne.NewStaticResource("86.jpg", resources.Constellations86)
	//змея := fyne.NewStaticResource("87.jpg", resources.Constellations87)
	//золотаяРыбка := fyne.NewStaticResource("88.jpg", resources.Constellations88)
