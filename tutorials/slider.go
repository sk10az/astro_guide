...
func (b *browser) setSliderIcon(index int) {
...
func sliderCheckerPattern(x, y, _, _ int) color.Color {
	x /= 20
	y /= 20
...
func iconSliderList(icons []iconInfo) []string {
